...
import hello.uap.utility.IntUtility;
...
public abstract class MessageBase {
    ...
    //protected String AccountName = "AcctName\0";
    protected String AccountName = "lukiza4";
    protected String Password = "luki422";        //C octet string ()
    protected final String SystemType = "USSD";    //C-Octet string (null terminator for octet string -can be ommitted)
    protected final int InterfaceVersion = 0x10;
    protected UssdVersions UssdVersion;
    protected UssdOpTypes UssdOpType;
    protected String MsIsdn;
    protected int ServiceCode = 422;
