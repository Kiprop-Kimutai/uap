...
import hello.uap.utility.StringUtility;
...
/*            arrayOutputStream.write(StringUtility.GetBytesFromOctetString(this.AccountName));
            arrayOutputStream.write(StringUtility.GetBytesFromOctetString(this.Password));
            arrayOutputStream.write(StringUtility.GetBytesFromCOctetString(this.SystemType,13));*/
