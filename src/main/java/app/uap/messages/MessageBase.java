...
import app.uap.utility.IntUtility;
...
public abstract class MessageBase {
    ...
    protected String Password = "Password\0";        //C octet string ()
    protected final String SystemType = "USSD\0";    //C-Octet string (null terminator for octet string -can be ommitted)
